...
bg_path = "plugins/group_manage/assets/Lucyinfo.png"
font_path = "plugins/group_manage/assets/lucyinfo.ttf"
...
@Client.on_message(filters.command(["me", "whois", "userinfo"], prefixes=["/", "!","."]))
    ...
    if not message.reply_to_message and len(message.command) == 2:
        ...
        try:
            ...
            if user.photo:
                ...
                # User doesn't have a profile photo, use anniephoto directly
                welcome_photo = random.choice(lucyphoto)
