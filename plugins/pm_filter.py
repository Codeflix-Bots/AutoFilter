...
from database.connections_mdb import active_connection, all_connections, delete_connection, if_active, make_active, \
    make_inactive
from info import ADMINS, AUTH_CHANNEL, AUTH_USERS, SUPPORT_CHAT_ID, CUSTOM_FILE_CAPTION, MSG_ALRT, PICS, AUTH_GROUPS, SUBSCRIPTION, P_TTI_SHOW_OFF, GRP_LNK, CHNL_LNK, NOR_IMG, LOG_CHANNEL, SPELL_IMG, MAX_B_TN, IMDB, \
...
async def next_page(bot, query):
    ...
    if not settings["button"]:
        if settings["imdb"]:
            ...
            cap = f"<b>ʜᴇʏ ʙʀᴏ {query.from_user.mention}, ғᴏᴜɴᴅ {total} ʀᴇsᴜʟᴛ ғᴏʀ ʏᴏᴜʀ ǫᴜᴇʀʏ {search}\n\n</b>"
